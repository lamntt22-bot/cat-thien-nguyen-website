...
export default function AboutSection() {
  return (
    <section id="ve-chung-toi" className="relative overflow-hidden bg-cream-50 py-16 sm:py-20">
      ...
      />
      <div
        className="absolute inset-0 bg-gradient-to-r from-cream-50/92 via-cream-50/70 to-cream-50/20"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto max-w-4xl px-5 sm:px-8">
        ...
        <h2 className="mt-2 max-w-xl font-display text-2xl font-semibold text-maroon-950 sm:text-3xl">
