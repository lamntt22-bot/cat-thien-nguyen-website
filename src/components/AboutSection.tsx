  ...
  return (
    <section id="ve-chung-toi" className="relative overflow-hidden bg-cream-50 py-16 sm:py-20">
      ...
      <div className="relative mx-auto max-w-4xl px-5 text-center sm:px-8">
        <div className="mx-auto max-w-2xl rounded-3xl bg-cream-50/88 px-5 py-6 backdrop-blur-md sm:px-10 sm:py-8">
          ...
          <p className="mt-4 text-ink-700">
            Việt Nam sở hữu nguồn dược liệu quý bậc nhất thế giới — nhưng đang dần mai một trước
            làn sóng lạm dụng thuốc Tây. Cát Thiên Nguyên ra đời để đưa dược liệu quý cấp 1 của
            Việt Nam trở lại đời sống hiện đại, xây dựng thói quen chăm sóc sức khỏe chủ động, cải
            thiện từ gốc rễ một cách nhẹ nhàng nhất — không thay thế y học hiện đại.
          </p>
        </div>
      </div>
