        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          ...
          <Reveal delayMs={100}>
            <div className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-gold-500/30 bg-maroon-950 p-7 text-cream-50 shadow-sm sm:p-8">
              ...
              <CraneCorner position="top-right" className="-right-8 -top-8 h-40 w-40 opacity-85" />
              <CraneCorner position="bottom-left" className="-bottom-8 -left-8 h-36 w-36 opacity-70" />
