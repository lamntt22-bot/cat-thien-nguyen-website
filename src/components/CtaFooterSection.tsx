...
export default function CtaFooterSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-maroon-950 py-16 text-center text-cream-50 sm:py-20">
      ...
      <CraneCorner position="top-right" className="-right-8 -top-10 h-44 w-44 opacity-85 sm:h-56 sm:w-56" />
      <CraneCorner position="bottom-left" className="-bottom-10 -left-8 h-44 w-44 opacity-85 sm:h-56 sm:w-56" />
