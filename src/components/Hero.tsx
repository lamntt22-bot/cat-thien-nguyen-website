  ...
  return (
    <section id="top" className="relative overflow-hidden bg-maroon-900">
      ...
      <div className="relative">
        ...
        <CraneCorner position="top-right" className="hidden h-48 w-48 opacity-65 lg:-right-10 lg:-top-10 lg:block" />
        <CraneCorner position="bottom-left" className="hidden h-48 w-48 opacity-65 lg:-bottom-10 lg:-left-10 lg:block" />
